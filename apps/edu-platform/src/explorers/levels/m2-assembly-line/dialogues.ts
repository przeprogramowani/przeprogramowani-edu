...
export const dialogues: Record<string, DialogueSequence> = {
  ...
  'm2-foundry-intro': {
    ...
    lines: [
      ...
      { speaker: 'astronaut', text: { pl: 'Katedra. Skala skacze o rząd. Wygasłe piece jak filary, szron na kadziach — a w ścianach galerii za halą żyły Synaptitu skrzą się w mroku. Bogactwo zamknięte w lodzie.', en: 'A cathedral. The scale jumps an order. Cold furnaces like pillars, frost on the ladles — and in the gallery walls behind the hall, Synaptit veins glitter in the dark. Wealth locked in ice.' }, mode: 'monologue' },
      { speaker: 'dr Kern', text: { pl: 'To huta rafinacyjna — czysty metal prosto z rudy. Poprowadzę wytop z wartowni. Parametry tej linii znam na pamięć.', en: 'This is a refining foundry — pure metal straight from the ore. I will run the melt from the guardhouse. I know this line\'s parameters by heart.' }, mode: 'dialogue' },
      { speaker: 'CORE AI', text: { pl: 'Otwórz galerię, zaplanuj dostawy rudy, uruchom linię — a ostatnią fazę, odlew, dokończ ręcznie. Maszyna doniesie wytop pod formę; ostatni ruch robisz ty.', en: 'Open the gallery, plan the ore deliveries, start the line — and the last phase, the cast, finish by hand. The machine carries the melt to the mould; the last move is yours.' }, mode: 'dialogue' },
    ],
  ...
  'm2-foundry-start': {
    ...
    lines: [
      ...
      { speaker: 'CORE AI', text: { pl: 'Pierwszy wytop od lat. Ta huta to kształt całej fabryki: najpierw plan, potem wykonanie, na końcu przegląd tego, co wróciło. Galeria, zwrotnica, ręczny odlew — w tej kolejności.', en: 'The first melt in years. This foundry is the shape of the whole factory: first the plan, then the execution, last the review of what comes back. Gallery, switchyard, manual cast — in that order.' }, mode: 'dialogue' },
