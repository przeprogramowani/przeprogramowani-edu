...
export const dialogues: Record<string, DialogueSequence> = {
  ...
  'm0-info-board': {
    ...
    lines: [
      ...
      { speaker: 'astronaut', text: { pl: 'Dziwne... ten protokół wygląda, jakbym nie tylko ja budził się bez pamięci.', en: 'Strange... this protocol looks like it expects more than just me waking up without memories.' }, mode: 'monologue' },
