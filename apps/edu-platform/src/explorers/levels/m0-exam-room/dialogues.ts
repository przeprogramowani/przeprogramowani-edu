...
export const dialogues: Record<string, DialogueSequence> = {
  ...
  'm0-study-notes-board': {
    ...
    lines: [
      ...
      { speaker: 'astronaut', text: { pl: 'Ktoś przygotował te materiały na wypadek utraty pamięci... Skąd wiedzieli?', en: 'Someone prepared these materials for the eventuality of memory loss... How did they know?' }, mode: 'monologue' },
    ],
    onComplete: {
