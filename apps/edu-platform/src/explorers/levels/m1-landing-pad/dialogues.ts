...
export const dialogues: Record<string, DialogueSequence> = {
  ...
  'm1-landing-intro': {
    ...
    lines: [
      ...
      { speaker: 'astronaut', text: { pl: 'Pierwszy raz na zewnątrz od przebudzenia. Powietrze pachnie czymś żywym — czymś, co nikogo nie pyta o pozwolenie.', en: 'First time outside since I woke. The air smells like something alive — something that asks no one\'s permission.' }, mode: 'monologue' },
      { speaker: 'CORE AI', text: { pl: 'Dexo. Jestem w łączu twojego skafandra, ale sensory wciąż mam martwe. Nie widzę tego księżyca — widzisz go ty. Opisz mi ten świat, cierpliwie, jak dziecku bez oczu. Jesteś moim jedynym czujnikiem.', en: 'Dexo. I am in your suit uplink, but my sensors are still dead. I cannot see this moon — you can. Describe this world to me, patiently, like to a child with no eyes. You are my only sensor.' }, mode: 'dialogue' },
      { speaker: 'Moreau', text: { pl: 'Dziecko bez oczu, jeden namiot i zero kawy. — Witaj w ekspedycji, Dexo. Moreau, inżynier. Zostaję na powierzchni, aż skończysz.', en: 'A child with no eyes, one tent, and no coffee. — Welcome to the expedition, Dexo. Moreau, engineer. I\'m staying on the surface till you\'re done.' }, mode: 'dialogue' },
      { speaker: 'dr Kern', text: { pl: 'Kern, geologia. Prowadzę was głosem z orbity. Ten księżyc ma coś w skorupie — czuję to nawet stąd.', en: 'Kern, geology. I\'m guiding you by voice from orbit. This moon has something in its crust — I can feel it from up here.' }, mode: 'dialogue' },
      { speaker: 'Moreau', text: { pl: 'Harris został na statku. Regeneracja synchronizacji neuronalnej — śpi. Zbudzimy go, jak będzie po co.', en: 'Harris stayed on the ship. Neural-sync regeneration — he\'s asleep. We\'ll wake him when there\'s a reason to.' }, mode: 'dialogue' },
      { speaker: 'CORE AI', text: { pl: 'Cel jest prosty do wypowiedzenia i trudny do wykonania: załóż przyczółek, odbuduj mi pierwszy zmysł. Zanim zacznę planować, muszę zobaczyć. Zacznij od obozu Moreau.', en: 'The objective is simple to say and hard to do: establish a foothold, rebuild me a first sense. Before I can plan, I must see. Start at Moreau\'s camp.' }, mode: 'dialogue' },
    ],
  ...
  'm1-camp-console-start': {
    ...
    lines: [
      ...
      { speaker: 'CORE AI', text: { pl: 'Zanim cokolwiek zbudujemy, potrzebuję rozpoznania. Trzy punkty na skraju polany. Podejdź do każdego, opisz mi go — z twoich słów złożę pierwszy obraz.', en: 'Before we build anything, I need reconnaissance. Three points on the edge of the clearing. Go to each, describe it — from your words I\'ll assemble a first picture.' }, mode: 'dialogue' },
      { speaker: 'astronaut', text: { pl: 'Czyli zwiad. Najpierw patrzeć, potem działać. — Da się zapamiętać.', en: 'So it\'s recon. Look first, act second. — I can remember that.' }, mode: 'dialogue' },
  ...
  'm1-camp-console-waiting': {
    ...
    lines: [
      { speaker: 'CORE AI', text: { pl: 'Wciąż czekam na trzy opisy: ściana dżungli na zachodzie, linia spalenizny przy promie, widok na grań od wschodu. Wróć, gdy obejdziesz wszystkie trzy.', en: 'I am still waiting on three descriptions: the jungle wall to the west, the burn line by the shuttle, the ridge view to the east. Come back once you have walked all three.' }, mode: 'dialogue' },
    ],
  },
  'm1-camp-report': {
    id: 'm1-camp-report',
    lines: [
      { speaker: 'astronaut', text: { pl: 'Obszedłem wszystko. Ściana dżungli — nieprzenikniona, ale żywa. Linia spalenizny — o tym jeszcze pogadamy. Grań na wschodzie — jest przejście, wąskie, ale jest.', en: 'I walked all of it. The jungle wall — impenetrable, but alive. The burn line — we\'ll come back to that. The ridge to the east — there\'s a pass, narrow, but it\'s there.' }, mode: 'dialogue' },
  ...
  'm1-survey-wall': {
    id: 'm1-survey-wall',
    lines: [
      { speaker: 'astronaut', text: { pl: 'Punkt pierwszy: ściana dżungli. Pnącza grube jak liny cumownicze, liście świecą własnym chłodnym światłem. Dalej niż na dwa kroki nic nie widać.', en: 'Point one: the jungle wall. Vines thick as mooring lines, leaves glowing with their own cold light. You can\'t see farther than two steps in.' }, mode: 'dialogue' },
      { speaker: 'CORE AI', text: { pl: 'Zapisane. Żywy księżyc rzadko bywa pułapką. Zapamiętaj to zdanie — może się jeszcze zemści.', en: 'Recorded. A living moon is rarely a trap. Remember that sentence — it may come back to bite us.' }, mode: 'dialogue' },
    ],
  ...
  'm1-survey-burn': {
    id: 'm1-survey-burn',
    lines: [
      { speaker: 'astronaut', text: { pl: 'Punkt drugi: linia spalenizny przy promie. Tyle że... to nie wzór z naszych silników. I skała jest wypalona głębiej, niż zrobiłoby to dzisiejsze lądowanie. To jest stare.', en: 'Point two: the burn line by the shuttle. Except... this isn\'t the pattern our engines leave. And the rock is scorched deeper than today\'s landing could reach. This is old.' }, mode: 'dialogue' },
      { speaker: 'CORE AI', text: { pl: 'Zapisuję jako anomalię. Ktoś tu wylądował przede mną — albo coś tu spadło. Nie mam czym tego zweryfikować. Na razie: zapamiętane.', en: 'Logging it as an anomaly. Someone landed here before me — or something fell here. I have nothing to verify it with. For now: remembered.' }, mode: 'dialogue' },
      ...
      { speaker: 'astronaut', text: { pl: 'Za późno.', en: 'Too late.' }, mode: 'monologue' },
    ],
  ...
  'm1-survey-ridge': {
    id: 'm1-survey-ridge',
    lines: [
      { speaker: 'astronaut', text: { pl: 'Punkt trzeci: widok na wschód. Grań wznosi się nad dachem dżungli, a między drzewami jest przejście. Wąskie, ale prowadzi w głąb — tam, gdzie kończy się polana.', en: 'Point three: the eastward view. A ridge rises above the canopy, and between the trees there is a pass. Narrow, but it leads inward — where the clearing ends.' }, mode: 'dialogue' },
      { speaker: 'CORE AI', text: { pl: 'Trzy opisy, trzy krawędzie mapy. Tyle wystarczy, bym przestał być ślepy na tej jednej polanie. Wróć do konsoli obozowej — złożę raport w całość.', en: 'Three descriptions, three edges of a map. Enough for me to stop being blind on this one clearing. Return to the camp console — I\'ll assemble the report.' }, mode: 'dialogue' },
    ],
  ...
  'q-m1-eyes-complete': {
    ...
    lines: [
      ...
      { speaker: 'CORE AI', text: { pl: 'Mam z czego rysować. Wróć do stołu obozowego i złóż raport — wtedy skieruję moc do obozu.', en: 'I have something to draw from. Return to the camp table and file the report — then I\'ll route power to the camp.' }, mode: 'dialogue' },
    ],
  },
  ...
  'm1-moreau-cricket': {
    ...
    lines: [
      { speaker: 'Moreau', text: { pl: 'Zbudowałeś świerszcza. Z wraku. Wróciłeś z dżungli z terkoczącym dronem, któremu nadałam imię przez łącze. Nie wiem, czy jestem dumna, czy przerażona.', en: 'You built a cricket. Out of a wreck. You came back from the jungle with a chirping drone I named over the link. I don\'t know whether I\'m proud or terrified.' }, mode: 'dialogue' },
      { speaker: 'astronaut', text: { pl: 'Na razie obie naraz. — I Świerszcz zostaje.', en: 'Both at once, for now. — And Świerszcz stays.' }, mode: 'dialogue' },
    ],
  },
  'm1-moreau-ore': {
    id: 'm1-moreau-ore',
  ...
  'm1-moreau-sensors': {
    ...
    lines: [
      ...
      { speaker: 'Moreau', text: { pl: 'I słuchaj... ta spalenizna, którą pierwszego dnia zbyłam. Widziałam takie ślady w archiwach. Nie zbyłam jej, bo się myliłam. Zbyłam ją, bo bałam się, że mam rację.', en: 'And listen... that scorch mark I brushed off on day one. I\'ve seen marks like it in the archives. I didn\'t brush it off because I was wrong. I brushed it off because I was afraid I was right.' }, mode: 'dialogue' },
    ],
  },
  'm1-moreau-epilogue': {
