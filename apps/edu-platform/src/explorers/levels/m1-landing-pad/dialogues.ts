...
export const dialogues: Record<string, DialogueSequence> = {
  ...
  'm1-landing-intro': {
    ...
    lines: [
      ...
      { speaker: 'Moreau', text: { pl: 'A ja jestem twoim jedynym namiotem, zdrowym rozsądkiem i — niestety — brakiem kawy; cała rezerwa mocy promu idzie na obóz. Moreau, inżynier. Zostaję tu, na powierzchni, dopóki nie skończysz.', en: 'And I\'m your only tent, common sense, and — sadly — the absence of coffee; the shuttle\'s whole power reserve goes to the camp. Moreau, engineer. I\'m staying up here, on the surface, till you\'re done.' }, mode: 'dialogue' },
      { speaker: 'dr Kern', text: { pl: 'Kern, geologia. Budzik z kapsuły numer cztery wyrwał mnie ze snu tuż przed lądowaniem — zostaję na orbicie, prowadzę was głosem. Ten księżyc ma coś w skorupie. Czuję to nawet stąd.', en: 'Kern, geology. The alarm from capsule four pulled me out of sleep just before the landing — I\'m staying in orbit, guiding you by voice. This moon has something in its crust. I can feel it from up here.' }, mode: 'dialogue' },
      { speaker: 'Moreau', text: { pl: 'Harris został na statku — regeneracja synchronizacji neuronalnej. Śpi. Zbudzimy go, jak będzie po co.', en: 'Harris stayed on the ship — neural-sync regeneration. He\'s asleep. We\'ll wake him when there\'s something to wake him for.' }, mode: 'dialogue' },
