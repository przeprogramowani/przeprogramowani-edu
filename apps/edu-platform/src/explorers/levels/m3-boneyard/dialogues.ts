...
export const dialogues: Record<string, DialogueSequence> = {
  ...
  'q-m3-true-fault-complete': {
    ...
    lines: [
      ...
      { speaker: 'CORE AI', text: { pl: 'Nie wymazali ci wiedzy w ogóle — wymazali twoje własne dzieło. Wschodnia śluza otwarta — jednostka szczera i sprawna prowadzi dalej.', en: 'They didn\'t erase your knowledge in general — they erased your own work. The eastern airlock is open — an honest, working unit leads on.' }, mode: 'dialogue' },
    ],
