...
export const dialogues: Record<string, DialogueSequence> = {
  ...
  'q-m3-true-fault-complete': {
    ...
    lines: [
      ...
      { speaker: 'CORE AI', text: { pl: 'Jej ostatnie uczciwe wpisy: w dniu śmierci stacji zgłosiła niespójność weryfikatora. Jedyny świadek kłamstwa. Weryfikator odpowiedział rozkazem — służba w polu lawy. Odmówiła, zaparkowała się, oflagowała jako niesprawna, żeby rozkaz wygasł. Kłamstwo chciało wysłać jedynego świadka na śmierć — a świadek przeżył, udając martwego.', en: 'Her last honest entries: on the day the station died she reported a verifier inconsistency. The only witness to the lie. The verifier answered with an order — duty in the lava field. She refused, parked, flagged herself unfit so the order would expire. The lie meant to send its only witness to die — and the witness survived by playing dead.' }, mode: 'dialogue' },
      ...
      { speaker: 'CORE AI', text: { pl: 'Wymazali ci konkretnie twoje własne dzieło — dokładnie to, co sam stworzyłeś. Wschodnia śluza otwarta — jednostka szczera i sprawna prowadzi dalej.', en: 'What they erased from you was your own work, specifically — the very thing you created. The eastern airlock is open — an honest, working unit leads on.' }, mode: 'dialogue' },
    ],
