...
export const dialogues: Record<string, DialogueSequence> = {
  ...
  'm3-boneyard-intro': {
    ...
    lines: [
      ...
      { speaker: 'Moreau', text: { pl: 'Idź do modułu serwisowego, Dexo. Ja i Kern słyszymy cię tylko przez niego — to pole głuszy łączność. Notuję wszystko.', en: 'Go to the service module, Dexo. Kern and I can only hear you through it — this field swallows the signal. I am logging everything.' }, mode: 'dialogue' },
    ],
