...
export const dialogues: Record<string, DialogueSequence> = {
  ...
  'q-m2-master-plan-complete': {
    ...
    lines: [
      ...
      { speaker: 'CORE AI', text: { pl: 'Z planowaniem online koreluję wybuch transmisji z Księżyca 1 z nowym odczytem czujników. Rozbłysk napędu głębiej w Pasie zmienił kurs po tamtej transmisji. Prognoza przecięcia trajektorii rośnie. Pościg przestaje być wnioskiem — jest obiektem na mapie.', en: 'With planning online, I correlate the transmission burst from Moon 1 with a new sensor read. A drive flare deeper in the Belt changed course after that burst. The intersection forecast is rising. The pursuit stops being an inference — it is an object on the map.' }, mode: 'dialogue' },
