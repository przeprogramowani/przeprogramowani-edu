...
export const dialogues: Record<string, DialogueSequence> = {
  ...
  'm2-dispatch-intro': {
    ...
    lines: [
      ...
      { speaker: 'astronaut', text: { pl: 'Wieża nad całą fabryką. Przez szkło — martwy kompleks w dole. Pod stropem Rdzeń Harmonogramu, obrośnięty szronem jak stalagmit, i trzy martwe tablice planu wokół. Wiatr, szkło, bezruch.', en: 'A tower over the whole factory. Through the glass — the dead complex below. Under the roof, the Schedule Core, frost-grown like a stalagmite, and three dead plan boards around it. Wind, glass, stillness.' }, mode: 'monologue' },
      { speaker: 'CORE AI', text: { pl: 'To serce, które zabili. Zatruty harmonogram siedzi w tym rdzeniu od lat. Wyczyszczę go przy pulpicie i złożę szkielet nowego planu — ale plan musi przejść walidację z Ziemią, zanim przełożysz dźwignię.', en: 'This is the heart they killed. The poisoned schedule has sat in this core for years. I will scrub it at the console and assemble the skeleton of a new plan — but the plan must pass validation with Earth before you throw the lever.' }, mode: 'dialogue' },
    ],
  ...
  'm2-dispatch-console-start': {
    ...
    lines: [
      ...
      { speaker: 'CORE AI', text: { pl: 'Rdzeń czysty. Szkielet planu głównego gotowy — ale wymaga walidacji krzyżowej z archiwami budowy Odyssey-F po stronie Ziemi. Ty uruchamiasz procedurę stąd. Klucz planu podpisuje człowiek w centrali — nie ja.', en: 'The core is clean. The master-plan skeleton is ready — but it needs cross-validation against the Odyssey-F build archives on Earth\'s side. You run the procedure from here. A human at HQ signs the plan key — not me.' }, mode: 'dialogue' },
  ...
  'q-m2-master-plan-complete': {
    ...
    lines: [
      ...
      { speaker: 'system', text: { pl: 'Ręka Dexo przekłada główną zwrotnicę. Wagonik na bocznicy rusza, kominy wydychają parę pierwszy raz od lat.', en: 'Dexo\'s hand throws the main switch. The siding tram moves, and the chimneys exhale steam for the first time in years.' }, mode: 'system', autoAdvance: 3000 },
      ...
      { speaker: 'CORE AI', text: { pl: 'Planuję.', en: 'I plan.' }, mode: 'dialogue' },
      { speaker: 'CORE AI', text: { pl: '…i wiem już, na co patrzeć.', en: '…and I know now what to look at.' }, mode: 'dialogue' },
      { speaker: 'CORE AI', text: { pl: 'Pierwszy plan, jaki układam, rekonstruuje zabójstwo tej fabryki. Zatruty harmonogram przyleciał tu z Ziemi w jej własnym ładunku, podpisany wewnętrznymi kluczami Projektu Odyssey. Znacznik kompilacji: godzina startu Odyssey.', en: 'The first plan I lay out reconstructs this factory\'s murder. The poisoned schedule rode here from Earth in its own cargo, signed with internal Project Odyssey keys. Compile stamp: the hour of Odyssey\'s launch.' }, mode: 'dialogue' },
