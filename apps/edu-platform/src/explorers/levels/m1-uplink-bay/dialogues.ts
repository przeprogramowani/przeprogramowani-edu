...
export const dialogues: Record<string, DialogueSequence> = {
  ...
  'q-m1-calibration-complete': {
    ...
    lines: [
      ...
      { speaker: 'CORE AI', text: { pl: 'To te same węzły ze Strefy Ciszy — sygnatura ENTROPY. Teraz wiem, czym jest „VOID”: siecią, którą spina. Śledzę wybuch — poszedł w głąb Pasa, precz od Ziemi. Właśnie dowiedzieli się, że tu jesteśmy.', en: 'These are the same nodes from the Silence Zone — the ENTROPY signature. Now I know what "VOID" is: the network it binds. I trace the burst — it ran deep into the Belt, away from Earth. They just learned that we are here.' }, mode: 'dialogue' },
