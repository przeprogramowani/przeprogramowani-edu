...
export const dialogues: Record<string, DialogueSequence> = {
  ...
  'm1-array-console-start': {
    ...
    lines: [
      ...
      { speaker: 'CORE AI', text: { pl: 'Tablica stoi, ale jej punkt odniesienia trzeba zweryfikować z danymi z Ziemi. To robota Nawigatora: w centrali odsieje radiolatarnie i prześle klucz kalibracji przez earthctl.', en: 'The array stands, but its reference point must be verified against Earth-side data. That\'s the Navigator\'s job: at HQ they\'ll filter the beacons and submit the calibration key via earthctl.' }, mode: 'dialogue' },
  ...
  'q-m1-calibration-complete': {
    ...
    lines: [
      ...
      { speaker: 'CORE AI', text: { pl: 'Te same węzły ze Strefy Ciszy — sygnatura ENTROPY. Teraz wiem, czym jest „VOID”: siecią, którą spina. Śledzę wybuch — poszedł w głąb Pasa, precz od Ziemi. Właśnie dowiedzieli się, że tu jesteśmy.', en: 'The same nodes from the Silence Zone — the ENTROPY signature. Now I know what "VOID" is: the network it binds. I trace the burst — it ran deep into the Belt, away from Earth. They just learned that we are here.' }, mode: 'dialogue' },
