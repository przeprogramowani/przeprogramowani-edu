...
export const dialogues: Record<string, DialogueSequence> = {
  ...
  'm1-array-console-start': {
    ...
    lines: [
      ...
      { speaker: 'CORE AI', text: { pl: 'Tablica stoi, ale jej punkt odniesienia trzeba zweryfikować krzyżowo z danymi z Ziemi. To zadanie po stronie Ziemi — Nawigator w centrali odsieje radiolatarnie i prześle klucz kalibracji przez earthctl.', en: 'The array stands, but its reference point must be cross-verified against Earth-side data. This is an Earth-side task — the Navigator at HQ will filter the beacons and submit the calibration key via earthctl.' }, mode: 'dialogue' },
  ...
  'q-m1-calibration-complete': {
    ...
    lines: [
      ...
      { speaker: 'CORE AI', text: { pl: 'To te same węzły, które nazwaliśmy w Strefie Ciszy — sygnatura ENTROPY. „VOID” to sieć, którą spina. Cztery nadajniki, jedno przeznaczenie.', en: 'These are the same nodes we named in the Silence Zone — the ENTROPY signature. "VOID" is the network it binds. Four transmitters, one purpose.' }, mode: 'dialogue' },
      { speaker: 'CORE AI', text: { pl: 'Śledzę kierunek wybuchu. Poszedł w głąb Pasa, precz od Ziemi. Oni tam właśnie dowiedzieli się, że tu jesteśmy.', en: 'I trace the burst\'s direction. It ran deep into the Belt, away from Earth. They out there just learned that we are here.' }, mode: 'dialogue' },
      ...
      { speaker: 'system', text: { pl: 'Misja ukończona! CORE AI zyskuje zmysł analizy otoczenia. Wróć na statek teleportem w pierwszym obszarze dżungli.', en: 'Mission complete! CORE AI gains the environment-analysis sense. Return to the ship via the teleport in the first jungle area.' }, mode: 'system', autoAdvance: 3000 },
    ],
  },
