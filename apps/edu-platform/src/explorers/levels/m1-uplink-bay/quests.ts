...
export const quests: ApiAnswerQuest[] = [
  {
    ...
    briefing: {
      pl: 'Tablica sensorów jest złożona i zasilona na grani, ale jej punkt odniesienia trzeba zweryfikować krzyżowo z danymi po stronie Ziemi. Nawigator: uruchom procedurę po stronie centrali, odsiej wiarygodne radiolatarnie, złóż klucz kalibracji i prześlij go przez earthctl.',
    ...
    hints: [
      ...
      { pl: 'Liczą się tylko radiolatarnie zweryfikowane, ze źródła earth-hq, z dryfem w tolerancji. Klucz układasz rosnąco po dryfie.', en: 'Only verified beacons, from source earth-hq, with drift within tolerance count. Order the key by ascending drift.' },
