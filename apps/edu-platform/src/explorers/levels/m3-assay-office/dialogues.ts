...
export const dialogues: Record<string, DialogueSequence> = {
  ...
  'q-m3-standard-complete': {
    ...
    lines: [
      ...
      { speaker: 'Moreau', text: { pl: 'Na Księżycu 1 — szum. Na Księżycu 2 — błąd sumy. Dziś ktoś poprawił naszą pomyłkę, zanim do nas wróciła. Po drugiej stronie łącza siedzi żywy rozmówca. Od dziś mamy dwa kanały: ten, który mamy, i ten, który zbudujemy.', en: 'On Moon 1 — noise. On Moon 2 — a checksum error. Today someone fixed our mistake before it came back. There is a living correspondent on the other end of the link. From today we have two channels: the one we have, and the one we will build.' }, mode: 'dialogue' },
