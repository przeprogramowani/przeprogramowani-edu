...
flowchart LR
    ...
    L1 --> L2 --> L3 --> L4 --> Q
```
<!-- rendered: ../../assets/diagrams/lessons-m1-l5-lesson-draft-1.png | cdn: https://images.przeprogramowani.pl/diagrams/lessons-m1-l5-lesson-draft-1.png -->
...
flowchart LR
    ...
    TS --> W --> R --> SC --> AB --> INF
```
<!-- rendered: ../../assets/diagrams/lessons-m1-l5-lesson-draft-2.png | cdn: https://images.przeprogramowani.pl/diagrams/lessons-m1-l5-lesson-draft-2.png -->
...
flowchart LR
    ...
    A --> B --> C
```
<!-- rendered: ../../assets/diagrams/lessons-m1-l5-lesson-draft-3.png | cdn: https://images.przeprogramowani.pl/diagrams/lessons-m1-l5-lesson-draft-3.png -->
...
flowchart LR
    ...
    P --> H --> A --> U
```
<!-- rendered: ../../assets/diagrams/lessons-m1-l5-lesson-draft-4.png | cdn: https://images.przeprogramowani.pl/diagrams/lessons-m1-l5-lesson-draft-4.png -->
...
```
<!-- rendered: ../../assets/diagrams/lessons-m1-l5-lesson-draft-5.png | cdn: https://images.przeprogramowani.pl/diagrams/lessons-m1-l5-lesson-draft-5.png -->
