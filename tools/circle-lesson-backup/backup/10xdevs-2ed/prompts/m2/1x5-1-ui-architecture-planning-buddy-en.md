---
title: "UI Architecture Planning Assistant"
description: "Interactive user interface design session. Generates questions about views, user flows, responsiveness, and API integration based on PRD."
