---
title: Workflow CI/CD Pull Request
description: >-
  Tworzy workflow GitHub Actions dla pull requestów, w tym linting, równoległe
  testy jednostkowe i e2e, zbieranie pokrycia oraz komentarze statusu PR.
collection: m3-prod
segment: l5-cicd
sort-order: 0
status: published
