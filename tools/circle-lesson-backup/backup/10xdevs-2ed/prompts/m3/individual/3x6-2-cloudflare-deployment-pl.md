---
title: Konfiguracja Deploymentu Cloudflare Pages
description: >-
  Konfiguruje projekt dla Cloudflare Pages i tworzy workflow GitHub Actions dla
  automatycznego wdrożenia bez testów e2e.
collection: m3-prod
segment: l6-deploy
sort-order: 1
status: published
