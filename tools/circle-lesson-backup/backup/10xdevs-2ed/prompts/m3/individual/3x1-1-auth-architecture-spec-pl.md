---
title: Specyfikacja Architektury Autentykacji
description: >-
  Tworzy kompleksową specyfikację techniczną systemu autentykacji, w tym
  architekturę UI, logikę backendową i integrację Supabase Auth w oparciu o
  wymagania PRD.
collection: m3-prod
segment: l1-auth
sort-order: 0
