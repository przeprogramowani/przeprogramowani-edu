---
title: Analiza Złożoności Komponentów
description: >-
  Analizuje folder komponentów w celu identyfikacji TOP 5 plików o największej
  liczbie linii kodu i sugeruje kierunki refaktoryzacji w oparciu o stos
  technologiczny.
collection: m3-prod
segment: l4-refactor
sort-order: 0
